Shader "PlayWay Water/Variations/Water _ALPHABLEND_ON _CUBEMAP_REFLECTIONS _INCLUDE_SLOPE_VARIANCE _NORMALMAP _PLANAR_REFLECTIONS_HQ _VOLUMETRIC_LIGHTING _WATER_FOAM_WS _WATER_RECEIVE_SHADOWS _WATER_REFRACTION _WAVES_FFT" {
	Properties {
		...
		_RefractionMaxDepth ("Refraction Max Depth", Float) = -1
		_WaterTileSize ("Heightmap Tile Size", Vector) = (180,18,600,1800)
		_WaterTileOffsets ("Tile Offsets", Vector) = (0,0,0,0)
